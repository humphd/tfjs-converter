...
2. Run converter script provided by the pacakge
...
4. Will it support a model with quantization?

Not yet. We are planning to add quantization support soon.

5. Why is the predict() method for inference so much slower the first time compared with subsequent calls?
